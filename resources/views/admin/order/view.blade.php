        ...
        <div class="card">
            <div class="card-header">
                <h3>My Orders Details
                    ...
                    <a href="{{ url('admin/invoice/'.$order->id) }}" class="btn btn-warning btn-sm float-end">View Invoice</a>
                </h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <h6 class="border p-2 text-success">
                            Order Status Message: <span>{{ $order->status_message }}</span>
                        </h6>
                    </div>
                    <div class="col-md-6">
                        <h5>User Details</h5>
                            ...
                            <tr>
                                ...
                                <td width="10%">
                                    @if ($orderItem->product->productImages)
                                        <img src="{{ asset($orderItem->product->productImages[0]->image) }}" style="width: 50px; height: 50px" alt="{{ $orderItem->product->image }}">
                                    @else
                                        <img src="" style="width: 50px; height: 50px" alt="{{ $orderItem->product->image }}">
                                    @endif
                                </td>
                                <td>
