    ...
    <div class="py-3 py-md-5 bg-light">
        <div class="container">
                                            ...
                                            <a href="{{ url('collections/'.$cartItem->product->category->slug.'/'.$cartItem->product->slug) }}">
                                                <label class="product-name">
                                                    @if ($cartItem->product->productImages)
                                                        <img src="{{ asset($cartItem->product->productImages[0]->image) }}" style="width: 50px; height: 50px" alt="{{ $cartItem->product->image }}">
                                                    @else
                                                        <img src="" style="width: 50px; height: 50px" alt="{{ $cartItem->product->image }}">
                                                    @endif
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="shadow-sm bg-white p-3 mt-2">
                        <h4>Total:
